...
export function StreamingAnalysis({
  ...
  if (error) {
    return (
      <div className={cn('rounded-lg border border-red-800 bg-red-900/20 p-4', className)}>
  ...
  return (
    <div
      className={cn(
        'rounded-lg border bg-gray-800 border-gray-700 overflow-hidden',
        className
      )}
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700 bg-gray-800/50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-gray-100">AI Analysis</span>
        </div>
        {isStreaming && (
...
function Cursor() {
  return (
    <span className="inline-block w-2 h-4 ml-0.5 bg-teal-400 animate-pulse" />
  );
}
...
export function StreamingAnalysisSkeleton() {
  return (
    <div className="rounded-lg border bg-gray-800 border-gray-700 overflow-hidden animate-pulse">
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700 bg-gray-800/50">
        <div className="flex items-center gap-2">
